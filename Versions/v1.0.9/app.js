...
function initLobby() {
  ...
  var SOON_CARDS = [
    { art: 'assets/soon-qajars.png?v=20260915-globe-21', name: 'front.soonQajar' },
    { art: 'assets/soon-pahlavis.png?v=20260915-globe-21', name: 'front.soonPahlavi' }
  ];
...
function boot() {
  ...
  /* Leaving the app and coming back is the one transition no screen change
     announces, so the bed it suspended is asked for again here. `pageshow` is the
     same repair for a page restored rather than unhidden — iOS WebView does both
     and which one fires depends on how it was put away. */
