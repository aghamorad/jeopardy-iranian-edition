...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      'boot.ready': 'Rolling',
      'boot.failed': 'An asset did not load',
      ...
      'front.back': 'Back',
      /* The creator's line. His name is his, and it is not translated — only
         what is said around it is. The span is a colour, not a word: it is what
         lets the name sit one step brighter than the two words in front of it,
         which is the whole difference between a byline and an imprint. */
      'front.credit': 'Made by <span class="credit-name">Morad</span>',
    ...
    fa: {
      ...
      'boot.failed': 'یکی از پرونده‌ها بارگیری نشد',
      'boot.retry': 'تلاش دوباره',
      ...
      'front.back': 'بازگشت',
      /* The name stays Latin in both languages: it is a name, not a word. */
      'front.credit': 'ساختهٔ <span class="credit-name">Morad</span>',
      'front.soon': 'به‌زودی',
      ...
      'settings.sprites': 'مجری و حبابها',
      'settings.voice': 'صدای مجری',
      'settings.volume': 'بلندی صدا',
