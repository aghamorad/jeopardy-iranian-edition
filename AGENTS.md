...
learns to read it — a `COURSE_SHELVES` line per absorbed course, its groups reproduced
verbatim, nothing hand-pasted into the generated file. That shelf is counted —
