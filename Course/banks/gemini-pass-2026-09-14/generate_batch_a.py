# Generate Batch A (Categories 1-10: 50 clues)
import sys
...
# Category 1: THE JIHAD OF BRICK AND MORTAR / جهاد با بیل و بی‌سیم (Single)
c1 = [
  {
    ...
    "value": 200,
    "difficulty": "CASUAL",
    "category": {"en": "THE JIHAD OF BRICK AND MORTAR", "fa": "جهاد با بیل و بی‌سیم"},
    "clue_text": {
    ...
    "canonical_answer": {"en": "Construction Jihad", "fa": "جهاد سازندگی"},
    "accepted_aliases": {
      "en": ["Jihad-e Sazandegi", "Jihad of Construction", "Crusade for Construction"],
      "fa": ["جهاد سازندگی", "نهاد جهاد سازندگی"]
    },
    "options": {
      "en": ["Bonyad-e Mostazafan", "Construction Jihad", "Basij Organization", "Islamic Revolutionary Komitehs"],
      "fa": ["بنیاد مستضعفان", "جهاد سازندگی", "سازمان بسیج", "کمیته‌های انقلاب اسلامی"]
    },
    ...
    "adversarial_confusion_set": {"en": ["Bonyad-e Maskan", "Basij-e Sazandegi"], "fa": ["بنیاد مسکن", "بسیج سازندگی"]},
    "specificity_prompt": {
  ...
  },
  {
    ...
    "canonical_answer": {"en": "Kheibar Bridge", "fa": "پل خیبر"},
    "accepted_aliases": {
      "en": ["Pol-e Kheibar", "Kheibar floating bridge", "Kheybar Bridge"],
      "fa": ["پل خیبر", "پل شناور خیبر"]
    },
    "options": {
      "en": ["Besat Bridge", "Naderi Bridge", "Kheibar Bridge", "Fajr Bridge"],
      "fa": ["پل بعثت", "پل نادری", "پل خیبر", "پل فجر"]
    },
    ...
    "adversarial_confusion_set": {"en": ["Besat Bridge", "Arvand Pontoon Bridge"], "fa": ["پل بعثت", "پل اروند"]},
    "specificity_prompt": {
  ...
  },
  {
    ...
    "canonical_answer": {"en": "Sangar-sazan-e Bi-Sangar", "fa": "سنگرسازان بی سنگر"},
    "accepted_aliases": {
    ...
    "options": {
      "en": ["Khat-shekanan", "Ghavasan-e Daryadel", "Shohada-ye Gomnam", "Sangar-sazan-e Bi-Sangar"],
      "fa": ["خط‌شکنان", "غواصان دریادل", "شهدای گمنام", "سنگرسازان بی سنگر"]
    },
    ...
    "adversarial_confusion_set": {"en": ["Khat-shekanan", "Janbazan"], "fa": ["خط‌شکنان", "جانبازان"]},
    "specificity_prompt": {
  ...
  },
  {
    ...
    "canonical_answer": {"en": "Literacy Movement Organization", "fa": "نهضت سوادآموزی"},
    "accepted_aliases": {
      "en": ["Nehzat-e Savad-Amoozi", "Literacy Movement", "Literacy Crusade"],
      "fa": ["سازمان نهضت سوادآموزی", "نهضت سواد آموزی"]
    },
    "options": {
      "en": ["Education Corps", "Literacy Movement Organization", "Farhang-e Farhangian", "Kanoon-e Parvaresh-e Fekri"],
      "fa": ["سپاه دانش", "نهضت سوادآموزی", "فرهنگ فرهنگیان", "کانون پرورش فکری"]
    },
    "correct_option_index": 1,
    "distractor_rationales": [
    ...
    "adversarial_confusion_set": {"en": ["Sepah-e Danesh", "Peykar Campaign"], "fa": ["سپاه دانش", "پیکار با بی‌سوادی"]},
    "specificity_prompt": {
  ...
  },
  {
    ...
    "canonical_answer": {"en": "Ministry of Agriculture", "fa": "وزارت کشاورزی"},
    "accepted_aliases": {
    ...
    "options": {
      "en": ["Ministry of Energy", "Ministry of Roads and Transportation", "Ministry of Cooperatives", "Ministry of Agriculture"],
      "fa": ["وزارت نیرو", "وزارت راه و ترابری", "وزارت تعاون", "وزارت کشاورزی"]
    },
    "correct_option_index": 3,
    "distractor_rationales": [
    ...
    "adversarial_confusion_set": {"en": ["Ministry of Energy", "Ministry of Rural Development"], "fa": ["وزارت نیرو", "وزارت عمران و روستایی"]},
    "specificity_prompt": {
...
batch_a.extend(c1)
print("Category 1 added:", len(batch_a))
EOF
python3 -c "import generate_batch_a"
